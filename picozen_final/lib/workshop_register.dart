...
class InsReg extends StatefulWidget{
 ...
 class InitState extends State<InsReg>{
  ...
  CollectionReference workshop_register = FirebaseFirestore.instance.collection('workshop_register');
  
    Future<void> addUser() {
      // Call the user's CollectionReference to add a new user
      return workshop_register
          .add({
