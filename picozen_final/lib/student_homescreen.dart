...
import 'package:picozen_final/search.dart';
import 'package:picozen_final/student_apply.dart';
import 'package:picozen_final/teacher.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:picozen_final/wdetail.dart';
import 'package:picozen_final/semester.dart';
...
final capitalcities =
    FirebaseFirestore.instance.collection("workshop_registration").where("facuname", isEqualTo: true);
            ...
            children: [
              StreamBuilder<QuerySnapshot>(
                ...
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => WorksList()),
                  );
                  print('clicked');
                },
                child: Padding(
